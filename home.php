...
<div class="uk-position-relative">
        <div class="uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="ratio: 7:5; animation: pull; autoplay: true;  autoplay-interval: 10000; velocity: 0.1">
    ...
    <div class="uk-section uk-container uk-padding-remove-left uk-margin-large-top">
        <div class="uk-grid-collapse" data-uk-grid>
            <div id="teste" class="uk-width-1-6 uk-flex uk-flex-center uk-position-relative">
                ...
                <img id="sol-cheio" class="uk-position-absolute recuar sol-lua" uk-sticky="offset: 200" src="img/hp/sol-cheio.svg" alt="">
            ...
            <div class="uk-width-expand uk-flex uk-flex-column uk-flex-center epocas-dia">
                <div class="manha uk-margin-large-top">
                    ...
                    <div class="uk-child-width-1-2 uk-grid-small" data-uk-grid>
                        <div><div class="border"><img src="img/hp/cards/Pastel de Nata.png" alt="" loading="lazy"></div></div>
                        <div><div class="border"><img src="img/hp/cards/Pastel de Nata.png" alt="" loading="lazy"></div></div>
                        <div><div class="border"><img src="img/hp/cards/Pastel de Nata.png" alt="" loading="lazy"></div></div>
                        <div><div class="border"><img src="img/hp/cards/Pastel de Nata.png" alt="" loading="lazy"></div></div>
                        <div><div class="border"><img src="img/hp/cards/Pastel de Nata.png" alt="" loading="lazy"></div></div>
